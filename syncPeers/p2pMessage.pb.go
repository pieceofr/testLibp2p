...
func (m *MockProtoMessage) GetCommand() string {
	if m != nil {
		return m.Command
	}
	return ""
...
func (m *MockProtoMessage) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
var fileDescriptor_a259f8162cba2831 = []byte{
	...
	0xc9, 0x81, 0x4b, 0xc0, 0x37, 0x3f, 0x39, 0x3b, 0x00, 0xe4, 0x3e, 0x24, 0x0b, 0x9d, 0x51, 0x2d,
	0x84, 0x72, 0xe1, 0x8e, 0x65, 0x52, 0x60, 0x84, 0x39, 0x36, 0x89, 0x0d, 0xec, 0x37, 0x63, 0x40,
	0x00, 0x00, 0x00, 0xff, 0xff, 0xad, 0x22, 0xce, 0xbd, 0xef, 0x00, 0x00, 0x00,
}
